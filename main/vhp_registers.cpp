...
const RegisterDesc registerDescriptions[]={
    ...
    {0x010A, 1, 4, BYTES  , "", "Serial number"},
    {0x010B, 1, 4, BYTES  , "", "Model name"   },
    ...
    {0x104F, 1, 34, BYTES, "", "Total history"},
    {0x1050, 1, 34, BYTES, "", "Daily history-0"},
    {0x1051, 1, 34, BYTES, "", "Daily history-1"},
    {0x1052, 1, 34, BYTES, "", "Daily history-2"},
    {0x1053, 1, 34, BYTES, "", "Daily history-3"},
    {0x1054, 1, 34, BYTES, "", "Daily history-4"},
    {0x1055, 1, 34, BYTES, "", "Daily history-5"},
    {0x1056, 1, 34, BYTES, "", "Daily history-6"},
    {0x1057, 1, 34, BYTES, "", "Daily history-7"},
    {0x1058, 1, 34, BYTES, "", "Daily history-8"},
    {0x1059, 1, 34, BYTES, "", "Daily history-9"},
    {0x105A, 1, 34, BYTES, "", "Daily history-10"},
    {0x105B, 1, 34, BYTES, "", "Daily history-11"},
    {0x105C, 1, 34, BYTES, "", "Daily history-12"},
    {0x105D, 1, 34, BYTES, "", "Daily history-13"},
    {0x105E, 1, 34, BYTES, "", "Daily history-14"},
    {0x105F, 1, 34, BYTES, "", "Daily history-15"},
    {0x1060, 1, 34, BYTES, "", "Daily history-16"},
    {0x1061, 1, 34, BYTES, "", "Daily history-17"},
    {0x1062, 1, 34, BYTES, "", "Daily history-18"},
    {0x1063, 1, 34, BYTES, "", "Daily history-19"},
    {0x1064, 1, 34, BYTES, "", "Daily history-20"},
    {0x1065, 1, 34, BYTES, "", "Daily history-21"},
    {0x1066, 1, 34, BYTES, "", "Daily history-22"},
    {0x1067, 1, 34, BYTES, "", "Daily history-23"},
    {0x1068, 1, 34, BYTES, "", "Daily history-24"},
    {0x1069, 1, 34, BYTES, "", "Daily history-25"},
    {0x106A, 1, 34, BYTES, "", "Daily history-26"},
    {0x106B, 1, 34, BYTES, "", "Daily history-27"},
    {0x106C, 1, 34, BYTES, "", "Daily history-28"},
    {0x106D, 1, 34, BYTES, "", "Daily history-29"},
    {0x106E, 1, 34, BYTES, "", "Daily history-30"},
